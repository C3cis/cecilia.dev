...
<template>
  ...
  class="py-18">
    <div class="text-center font-serif">
      ...
      <h1 class="text-left text-6xl font-bold mt-8">Cursos & Certificações</h1>
    ...
    <div class="flex flex-row gap-10 mt-10 font-serif">
      ...
      <div class="flex items-center gap-3">
        ...
        <p class="text-sm text-muted-foreground leading-tight max-w-[25ch]">Áreas de Foco</p>
      </div>
    </div>
</section>
<section class="py-10">
    <div class="flex flex-row items-center gap-4 font-serif">
      <Icon name="famicons:school-sharp" class="text-primary text-4xl shrink-0" />
      <div class="flex flex-col">
        <span class="text-sm uppercase tracking-wide text-muted-foreground">Formação Acadêmica</span>
        <h2 class="text-2xl font-bold text-foreground">Cursos & Certificações</h2>
      </div>
    </div>
...
<section class="py-10">
    ...
    <!-- Um card por certificado (certificacoes vem auto-importado do utils) -->
