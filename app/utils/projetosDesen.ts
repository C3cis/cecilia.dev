...
export const projetos: Projeto[] = [
  {
    ...
    conteudo:
      'Aplicação web desenvolvida na arquitetura MVC para controle e gerenciamento administrativo de equipamentos.',
  ...
  },
  {
    ...
    conteudo:
      'Desenvolvimento web de um portal informativo sobre empreendedorismo, transformação digital e ecossistema de negócios.',
  ...
  },
  {
    ...
    conteudo:
      'Desenvolvimento de um aplicativo web de e-commerce, com funcionalidades de carrinho de compras, checkout e integração com API.',
